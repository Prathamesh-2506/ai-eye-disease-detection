...
A fine-tuned ResNet34 model is trained for 15 epochs on the augmented dataset to classify five eye disease categories: Glaucoma, Cataracts, Uveitis, Crossed Eyes, and Bulging Eyes. See notebook for detailed results.
